(() => {
  ...
  let n = {
    ...
    formClean(e) {
      ...
      for (let e = 0; e < t.length; e++) {
        const s = t[e];
        s.parentElement.classList.remove("_focus"),
      ...
      if (i.length > 0)
        for (let e = 0; e < i.length; e++) {
          const t = i[e],
            s = t.getAttribute("data-default");
          (t.value = s), select_item(t);
        }
    },
    emailTest: (e) =>
  ...
  const X = {
      attachEvents: function () {
        ...
        (e.onTouchStart = N.bind(e)),
          ...
          (e.onClick = j.bind(e)),
          i.touch && !W && (t.addEventListener("touchstart", F), (W = !0)),
          R(e, "on");
      },
      ...
      document.querySelector(".swiper") &&
        new se(".swiper", {
          ...
          breakpoints: {
            ...
            540: { slidesPerView: 1.4, spaceBetween: 20, autoHeight: !0 },
            768: { slidesPerView: 2, spaceBetween: 20 },
            992: { slidesPerView: 3, spaceBetween: 20 },
            1248: { slidesPerView: 3.2, spaceBetween: 20 },
  ...
  (window.onload = function () {
    document.addEventListener("click", function (e) {
      const t = e.target;
      let s = document.querySelector(".slider-content__row-1"),
        i = document.querySelector(".slider-content__row-2"),
        n = document.querySelector(".slider-row__button");
      t.classList.contains("search-form__icon")
        ? t.closest(".search-form").classList.toggle("_active")
        : !t.closest(".search-form") &&
          document.querySelector(".search-form._active") &&
          document.querySelector(".search-form").classList.remove("_active");
      t.classList.contains("header-burger__image")
        ? t.closest(".header__burger").classList.toggle("_active")
        : !t.closest(".header__burger") &&
          document.querySelector(".header__burger._active") &&
          document.querySelector(".header__burger").classList.remove("_active");
      t.classList.contains("header-shoppingcart__icon") ||
      t.classList.contains("header-shoppingcart__p")
        ? t.closest(".header__shoppingcart").classList.toggle("_active")
        : !t.closest(".header__shoppingcart") &&
          document.querySelector(".header__shoppingcart._active") &&
          document
            .querySelector(".header__shoppingcart")
            .classList.remove("_active");
      t.classList.contains("arrow__button") &&
      ...
      e.length &&
        ...
        document.body.addEventListener("focusout", function (e) {
          ...
          ("INPUT" !== t.tagName && "TEXTAREA" !== t.tagName) ||
            ...
            t.parentElement.classList.remove("_focus"),
